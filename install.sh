...
display_welcome() {
  ...
  echo -e "${BLUE}[+]                  © REREZZ OFFICIAL                [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${RED}[+] =============================================== [+]${NC}"
  echo -e ""
  echo -e "script ini di buat untuk mempermudah penginstalasian thema pterodactyle,"
  echo -e "Script Pripat Rerezz Official."
  echo -e "REREZZ OFFICIAL"
  echo -e "𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠 :"
  echo -e "@https://t.me/rerez_x_hosting"
  echo -e "𝗖𝗥𝗘𝗗𝗜𝗧𝗦 :"
  echo -e "@Rerezz Offc"
  sleep 4
  clear
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY NEROXXX OFFC             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "Rerezz Offc" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke REREZZ${NC}"
    echo -e "${YELLOW}TELEGRAM : t.me/rerez_x_hosting${NC}"
    echo -e "${YELLOW}WHATSAPP : 6283841605780${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}© Rerezz Offc${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/RerezzOffc/AnisaDiatyz/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/RerezzOffc/AnisaDiatyz/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer Rerezz   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : REREZZ_X_HOSTING ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : REREZZ OFFC  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by Rerezz Official  ${NC}"
